...
clouds.jpg and GitHub-Mark.PNG are open source images which can be found throught 

link:https://pixabay.com/zh/photos/clouds-nature-sky-cumulus-weather-4215608/

Openweather API is also free to use 
